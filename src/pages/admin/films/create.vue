<template>
    <div>
        <form @submit.prevent="createFilms()">
            <a-card title="Thêm mới phim" style="width: 100%;">
                <div class="row mb-2">
                    ...
                    <div class="col-12 col-sm-8">
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-sm-5">
                                ...
                                <a-input placeholder="Tên" v-model:value="name" allow-clear />
                                <div class="w-100">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-sm-5">
                                <a-select show-search placeholder="Dạng phim" style="width: 100%"
                                    v-model:value="subtitle_id" :options="films_subtitle" :filter-option="filterOption">
                                </a-select>
                                <div class="w-100">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-sm-5">
                                <a-date-picker value-format="YYYY-MM-DD" placeholder="Ngày khởi chiếu" style="width: 100%"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-sm-5">
                                <a-date-picker placeholder="Hết công chiếu" style="width: 100%" value-format="YYYY-MM-DD"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-sm-5">
                                <a-time-picker value-format="HH:mm:ss" style="width: 100%" v-model:value="duration">
                                </a-time-picker>
                                <div class="w-100">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-sm-5">
                                <a-textarea placeholder="Mô tả" :rows="3" v-model:value="description" />
                                <div class="w-100">
...
export default defineComponent({
    setup() {
        ...
        const router = useRouter();// tạo biến router để điều hướng
        ...
        const getFilmsCreate = () => {
            axios.get("http://127.0.0.1:8000/api/films/create") //nhớ là phải đặt trong ngoặc kép
        ...
        const createFilms = () => {
            axios.post("http://127.0.0.1:8000/api/films/create", films) //truyền tham số films vào, đẩy nó lên server
                .then(function (response) {
                    // handle success
